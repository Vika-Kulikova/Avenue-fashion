var gulp       = require('gulp'), // Подключаем Gulp
  ...
  plumber      = require('gulp-plumber');// Подключаем библиотеку для автоматического формирования вывода об ошибке. Но при этом работа Gulp не прерывается.
...
gulp.task('scripts', function() {
  return gulp.src([ // Берем все необходимые библиотеки
    ...
    'src/libs/jquery.form-styler/dist/jquery.formstyler.min.js',
    'src/libs/mixitup/build/jquery.mixitup.min.js',
    'src/libs/desandro-matches-selector/matches-selector.js'
  ])
    .pipe(plumber())
